...
use Iddigital\Cms\Common\Structure\Tests\DateTime\DateOrTimeRangeTest;
...
class TimeRangeTest extends DateOrTimeRangeTest
{
    ...
    {
        $range = new TimeRange(
                $start = new Time(06, 03, 05),
                $end = new Time(06, 04, 05)
        );
    ...
    public function testContains()
    {
        ...
        $this->assertSame(true, $range->contains(new Time(06, 03, 20)));
        $this->assertSame(true, $range->contains($end));

        $this->assertSame(false, $range->contains(new Time(06, 03, 04)));
        $this->assertSame(false, $range->contains(new Time(06, 04, 06)));
        $this->assertSame(false, $range->contains(new Time(03, 03, 20)));
    }
    ...
    public function testContainExclusive()
    {
        ...
        $this->assertSame(true, $range->containsExclusive(new Time(06, 03, 06)));
        $this->assertSame(true, $range->containsExclusive(new Time(06, 03, 20)));
        $this->assertSame(false, $range->containsExclusive($end));

        $this->assertSame(false, $range->containsExclusive(new Time(06, 03, 04)));
        $this->assertSame(false, $range->containsExclusive(new Time(06, 04, 06)));
        $this->assertSame(false, $range->containsExclusive(new Time(03, 03, 20)));
    }
    ...
    public function testOverlaps()
    {
        ...
        $range2 = new TimeRange(
                $start = new Time(06, 03, 30),
                $end = new Time(06, 05, 30)
        );

        $range3 = new TimeRange(
                $start = new Time(06, 05, 20),
                $end = new Time(06, 06, 20)
        );
